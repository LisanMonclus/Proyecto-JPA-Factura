...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Domicilio dom = new Domicilio("las cañas" , 1808);

            //CREAR CLIENTE Y SE SETEAN ATRIBUTOS
            Cliente cliente = new Cliente("Lisandro" , "Monclus" , 44625831);
            ...
            //CREAR ARTICULOS
            Articulo articulo1 = new Articulo(100, "Cocacola" , 2000);
            Articulo articulo2 = new Articulo(50 , "chocolates" , 500);
